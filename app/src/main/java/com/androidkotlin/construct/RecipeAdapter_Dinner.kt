...
class RecipeAdapter_Dinner(private  val recipeLunchList : ArrayList<Recipes>) : RecyclerView.Adapter<RecipeAdapter_Dinner.recipeViewHolder>(){
    ...
    override fun onBindViewHolder(holder: recipeViewHolder, position: Int) {
        ...
        holder.button_recipe.setOnClickListener{
            val intent = Intent(mContext, RecipeLunchReciclerViewActivity::class.java)
